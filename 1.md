...
**1.4 Beyond the Browser: Where JavaScript Can Run**
...
### 1.4.1 JavaScript Variants and Scripting Platforms
...
### 1.4.2 JavaScript Beyond the Cloud: Node.js
...
### 1.4.3. Why These Environments Matter
...
### **1.5.1 Running JavaScript in the Browser Console**
...
### **1.5.2 Running JavaScript in other Platforms**
...
### **1.5.3 Choosing the Right Environment**
